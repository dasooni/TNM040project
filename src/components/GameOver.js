...
function End({appState, onPlayScreen, onScoreBoard, onStartScreen}) {
    ...
    return (
        ...
        <div id = "ease-in">
            ...
            <button className = "play-again" onClick={onPlayScreen}>Play Again</button>
            <button className = "scoreboard" onClick={onScoreBoard}>Scoreboard</button>
            <button className = "start-again" onClick={onStartScreen}>Start Screen</button>
            </div>
        </div>
        </div>
    );
